...
//Creating the food on the game board randomly generated
...
//Make sure that the user input is valid and change the snake direction variable
...
//Accessed the correct pixel within the HTML collection
  ...
  //Check if the snake head is about to intersect with its own body
  ...
  //Describe what to do if a snake encounters a food pixel
